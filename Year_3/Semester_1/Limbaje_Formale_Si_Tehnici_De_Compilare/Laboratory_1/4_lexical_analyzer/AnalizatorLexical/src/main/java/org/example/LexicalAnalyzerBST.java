...
public class LexicalAnalyzerBST {
    ...
    private TSBinarySearchTree ts = new TSBinarySearchTree();
    ...
    // Write TS to files
    // Write TS to files
    private void writeTSToFile(String filename, TSBinarySearchTree table, String type) {
    ...
    public void lexicalAnalysis(String filename, String jsonFile) {
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
                ...
                // Output results
                writeTSToFile("TS_identifiers_BST.csv", ts,"ID");  // Save identifier table
                writeTSToFile("TS_constants_BST.csv", ts,"CONST");      // Save constant table
                writeFIPToFile("FIP_BST.csv");                            // Save FIP with names and positions
