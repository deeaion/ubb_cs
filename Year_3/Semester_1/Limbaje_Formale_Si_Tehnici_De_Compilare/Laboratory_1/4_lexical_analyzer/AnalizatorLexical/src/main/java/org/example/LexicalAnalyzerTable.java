...
import org.example.Implementations.HashTable.TSBinarySearchTree;
import org.example.Implementations.HashTable.TSOrderedList;
...
public class LexicalAnalyzerTable {
    ...
    private List<FIPItem> FIP = new ArrayList<>(); // FIP will store atom type, name, and position
    private List<String> atoms = new ArrayList<>();
    // Separate symbol tables for identifiers and constants
    private TSOrderedList ts = new TSOrderedList();
    private List<AnalyzerError> errorList = new ArrayList<AnalyzerError>(); // Store errors in an error list
    ...
    // Write TS to files
    // Write TS to files
    private void writeTSToFile(String filename, TSOrderedList table, String type) {
    ...
    public void lexicalAnalysis(String filename, String jsonFile) {
        try {
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
                ...
                // Output results
                writeTSToFile("TS_identifiers_Table.csv", ts,"ID");  // Save identifier table
                writeTSToFile("TS_constants_Table.csv", ts,"CONST");      // Save constant table
                writeFIPToFile("FIP_Table.csv");                            // Save FIP with names and positions
