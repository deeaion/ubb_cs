...
class SubjectsService {
     ...
     *
     */
    DynamicVector<Subject> generalSort(bool(*cmpKey)(const Subject &, const Subject &));
     ...
     *
     */
    DynamicVector<Subject> filter(const function<bool(const Subject &)> &fct);
...
public:
     ...
     */
    const DynamicVector<Subject>& getAll() noexcept;
    ...
    DynamicVector<Subject> filterByHours(int hours);

    /*Filter by teacher's name*/
    DynamicVector<Subject> filterByTeacher(const string &teacher);

    /** SORT*/
    /*
     * Sort by name of subject
     */
    DynamicVector<Subject> sortByName();

    /*
     * Sort by number of hours
     */
    DynamicVector<Subject> sortByHours();

    /*
     * Sort by teacher and type
     */
    DynamicVector<Subject> sortByTeacherandType();
