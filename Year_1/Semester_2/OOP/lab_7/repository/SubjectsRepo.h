...
private:
    ...
    DynamicVector<Subject> subjects;

public:

     explicit SubjectsRepo(const DynamicVector<Subject>& subjects):subjects{subjects}{
    };
     ...
     */
    [[nodiscard]] const DynamicVector<Subject> &getAll() const noexcept;
