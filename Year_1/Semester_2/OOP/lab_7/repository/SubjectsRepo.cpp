...
int SubjectsRepo::searchForSubject(const string &name, const string &teacher) {
     DynamicVector<Subject> sbjs = this->subjects;
    for (int i = 0; i < (int) this->subjects.getSize(); i++)
...
const DynamicVector<Subject> &SubjectsRepo::getAll() const noexcept {
