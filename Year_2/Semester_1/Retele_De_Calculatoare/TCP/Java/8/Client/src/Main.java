...
public class Main {
    ...
    public static void main(String args[])
    {
        ...
        try{
            ...
            String numere1=readStringFromConsole("Dati numerele: ",reader);
            String numere2=readStringFromConsole("Dati numerele: ",reader);
            byte[] nrToSend1=transformStringNumbersToByte(numere1);
            byte[] nrToSend2=transformStringNumbersToByte(numere2);
            writeIntegertoSocket(nrToSend1.length,socket,socketOut);
            writeIntegertoSocket(nrToSend2.length,socket,socketOut);
            writeByteArrayToSocket(nrToSend1,socketOut);
            writeByteArrayToSocket(nrToSend2,socketOut);
    ...
    private static void readResult(Socket socket,DataInputStream socketIn) throws IOException {
            int nrNumere=0;
           nrNumere=socketIn.readUnsignedShort();
            byte [] numere=new byte[nrNumere];
