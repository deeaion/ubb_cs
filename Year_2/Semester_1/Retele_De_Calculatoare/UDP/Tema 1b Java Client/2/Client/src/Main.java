...
public class Main {
    ...
    public static void main(String args[])
    {
        ...
        try{
            ...
            String string=readStringFromConsole("Please enter the string",reader);
            System.out.println(string);
            writeIntegertoSocket(string.length(),socket,socketOut);
            writeStringToSocket(string,socket,socketOut);
    ...
    private static void readResult(Socket socket,DataInputStream socketIn) throws IOException {
        int numaraparitii=0;
        numaraparitii=socketIn.readShort();
        System.out.println("Aparitia lui \" \" este de "+numaraparitii);
